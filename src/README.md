...
### A primer on the Math Memorization:
...
The Major System ties a number to consonant sounds and allowing those consonants to be used with vowels and semi-vowels to construct words, phrases, or familiar sounds that can be encoded and decoded quickly and consistently. It is a very literal transcoding.
...
4a. Open the practice mode and practice specific consonat and number combinations as required.
...
- Profiles
	- menu select profiles to load
		...
		- Log sessions 
		- Seralize/deserialize session data for uploading
- skill decay 
